...
* **Sept 8** - [Assignment 1 Milestone 1 Program](assign/assign01.html) Due - upload to [Marmoset](https://cs.ycp.edu/marmoset).
* **Sept 14** - [Assignment 1 Written](assign/assign01.html) Due - upload *self-graded* .pdf to Canvas by **Sept 16**.
* **Sept 15** - [Assignment 1 Milestone 2 Program](assign/assign01.html) Due - upload to [Marmoset](https://cs.ycp.edu/marmoset).
* **Sept 22** - [Assignment 2 Milestone 1 Program](assign/assign02.html) Due.
* **Sept 23 - NO CLASS, Career Expo**
...
* **Nov 16** - [Final Project](assign/project.html), Milestone 2 Demo.
* **Nov 18** - [Assignment 4 Written](assign/assign04.html) Due - upload *self-graded* .pdf to Canvas by **Nov 20**.
* **Nov 22** - [Assignment 4 Milestone 2 Program](assign/assign04.html) Due.
* **Nov 23 - EXAM III**
* **Dec 14 - FINAL PROJECT DEMOS - 12:30PM**
